...
async def _create_summary(chatlog_rows: List[str], name: str) -> Optional[str]:
    ...
    system_msg = (
        ...
        f"{(
            "\nHere are some proper nouns we use in our campaign. If you encounter an unusual word or phrase, it may be one of these, and you should replace it with such:\n"
        ...
        "Make sure your recap follows the order of events as they unfold in the transcript and do not make up quotes."
        "Maintain a playful, engaging, and enthusiastic tone.\n"
        f"{(
